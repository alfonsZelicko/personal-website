...
## Tech Overview: AI Companion as a Service
...
Risk: Building a really "universal" SDK is a massive engineering nightmare. Without deep AND
per-game integration, the AI will suffer from "context hallucinations" – I am very sure about it.
...
The Conflict: If a player only wants to know "Where is the hidden key?", a complex cross-game
behavioral memory is over-engineering.

Risk: The project might become a "solution looking for a problem" rather than a must-have tool.

### Success means BAN

And let's be honest: If I am even able to start AND finish this project into some usable version and
it will be successful - the game companies behind game studios will instantly ban me, and they will
create their own solution: SASS is for them just too sweet.

## Implementation Roadmap

1.  **Phase 1 (MVP):** Skyrim mod + Voice Chat[^7] + Local RAG (Lore DB).
